Conversation of Money Ltd ("we", "our" or "us") runs Calm Money. This policy explains what personal information we collect, why, how we use it and the rights you have. It covers this website, our emails and the Calm Money programme.

## Who we are

Conversation of Money Ltd is the data controller for your personal information. We are a company registered in the United Kingdom.

- **Address:** 5 Brayford Close, London, E1 0SG
- **Email:** [hello@peterkomolafe.com](mailto:hello@peterkomolafe.com)
...
UK data protection law requires us to have a lawful basis for each way we use your information.

- **To deliver the programme you've bought**, including access to the platform, coaching, WhatsApp support and meet-ups. Basis: to perform our contract with you.
- **To take payments, issue receipts and handle refunds.** Basis: contract, and our legal obligations, such as keeping tax records.
...
We never sell your personal information, and we don't share it with other companies for their own marketing.
...
- with our professional advisers, such as accountants and lawyers;
- with the police, regulators or courts, where the law requires it;
- with a buyer, if we sell all or part of our business, who must keep to this policy.
...
- **Mailing list:** until you unsubscribe. After that we keep your email address on a suppression list so we don't email you again by mistake.
...
We use secure, encrypted connections on this website, limit who can access your information and choose providers with strong security. No system is completely secure, but if a data breach puts your rights at risk, we will tell you and the Information Commissioner's Office as the law requires.
...
- object to how we use it, including for marketing at any time;
- ask us to send it to you or another organisation in a common format;
- withdraw your consent at any time, where we rely on consent. This doesn't affect anything we did before you withdrew it.

To use any of these rights, email [hello@peterkomolafe.com](mailto:hello@peterkomolafe.com). We'll reply within one month. We may ask you to confirm your identity first. There's no charge in most cases.

If you're unhappy with how we've handled your information, please tell us first so we can put it right. You also have the right to complain to the Information Commissioner's Office (ICO) at [ico.org.uk](https://ico.org.uk) or on 0303 123 1113.
...
Our website links to other sites, such as YouTube. We're not responsible for how they handle your information, so please read their privacy policies.

## Children

Calm Money is for adults. We don't knowingly collect information from anyone under 18. If you think a child has given us their information, please contact us and we'll delete it.

## Changes to this policy

We may update this policy from time to time. We'll post the new version here with the date it was updated, and if the changes are significant, we'll tell you by email.

## Contact us

If you have any questions about this policy or your information, email [hello@peterkomolafe.com](mailto:hello@peterkomolafe.com) or write to Conversation of Money Ltd, 5 Brayford Close, London, E1 0SG.
